%%
% Plot gain curves. Load data from .mat workspace file. Plot only
% Matlab-computed data, not simulation comparison
% ------------------------------------------------------------------------
...
tikzfile = '.\results\tikz_figures\SDSB_result_scan20.tex';
...
plot(rad2deg(theta_plt), 10*log10(g_cor_realizable(pltidx)), 'm', 'LineWidth', 1)
